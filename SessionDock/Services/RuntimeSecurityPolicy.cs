...
public static class RuntimeSecurityPolicy
{
        ...
        out string reason)
    {
        ...
        {
            reason =
                "SessionDock must be started as a standard user, not as administrator.";
            return false;
        }
        ...
        {
            reason =
                "SessionDock requires an interactive Windows user session.";
            return false;
        }
        ...
        {
            reason =
                "SessionDock cannot run under a Windows service identity.";
            return false;
        }
